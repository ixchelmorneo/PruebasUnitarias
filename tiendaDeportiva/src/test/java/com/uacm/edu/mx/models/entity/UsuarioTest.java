...
/****Cosntructor***/	
	...
	public void testSetNombreInvalido() throws ApplicacionExcepcion {
		...
		try {
			...
			Assert.assertEquals(e.getMessage(), CodigoError.MAL_NOMBRE_USUARIO);
	...
	public void testSetApellidoPInvalido() throws ApplicacionExcepcion {
		...
		try {
			...
			Assert.assertEquals(e.getMessage(), CodigoError.ERROR_APELLIDO_PATERNO_USUARIO);
...
/******** Apellido Materno **********/
	...
	public void testSetMaternoPInvalido() throws ApplicacionExcepcion {
		...
		try {
			...
			Assert.assertEquals(e.getMessage(), CodigoError.ERROR_APELLIDO_MATERNO_USUARIO);
...
/******** Telefono **********/
	...
	public void testSetTelefonoInvalido() throws ApplicacionExcepcion {
		...
		try {
			...
			Assert.assertEquals(e.getMessage(), CodigoError.ERROR_TELEFONO_USUARIO);
	...
	public void testSetDirecionInvalido() throws ApplicacionExcepcion {
		...
		try {
			...
			Assert.assertEquals(e.getMessage(), CodigoError.ERROR_DIRECION_USUARIO);
	...
	public void testSetEmailInvalido() throws ApplicacionExcepcion {
		...
		try {
			...
			Assert.assertEquals(e.getMessage(), CodigoError.ERROR_CORREO_USUARIO);
	...
	public void testSetPaswordInvalido() throws ApplicacionExcepcion {
		...
		try {
			...
			Assert.assertEquals(e.getMessage(), CodigoError.ERROR_PASWORD_USUARIO);
